...
green "real_addr  ="$real_addr
green "local_addr = "$local_addr
red  "请确保 real_addr  与 local_addr 一致"
if [ $real_addr == $local_addr ] ; then
	...
	if test -s /usr/src/trojan-cert/trojan.crt; then
        cd /usr/src
	...
	cat > /usr/src/trojan/server.conf <<-EOF
{
    ...
    "log_level": 1,
    "ssl": {
        "cert": "/usr/src/trojan-cert/trojan.crt",
...
EOF
	...
	red "5、密码:$trojan_passwd"
	green "======================================================================"
	else
        red "================================"
	red "请检查是否有上传证书/usr/src/trojan-cert/private.key  /usr/src/trojan-cert/trojan.crt 至本服务器，上传完成后重新安装"
	red "================================"
	fi
...
start_menu(){
    ...
    green " 系统：>=centos7                       "
    green " 作者：yjf                      "
    red   " 请自行上传nginx证书 /usr/src/trojan-cert/private.key  /usr/src/trojan-cert/trojan.crt 至本服务器 " 
   green " ===================================="
    echo
    green " 1. 安装trojan"
    red " 2. 卸载trojan"
